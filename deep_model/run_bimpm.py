...
from model.util.data_manager import DataManager
...
def main():
    ...
    argparser.add_argument("--mode", type=str,
                           ...
                           help=("One of {train|predict}, to "
                                 ...
                                 "DataIndexer to load."))
    argparser.add_argument("--model_load_dir", type=str,default='./data/models/bimpm/0/',
    ...
    argparser.add_argument("--num_sentence_words", type=int, default=30,
                           help=("The maximum length of a sentence. Longer "
                                 ...
                                 "ones will be padded."))
    argparser.add_argument("--num_word_characters", type=int, default=5,
    ...
    argparser.add_argument("--pretrained_embeddings_file_path", type=str,
                           ...
                           default=os.path.join('./data/external/',
                                                "glove.6B.100d.txt"))
    argparser.add_argument("--char_embedding_dim", type=int, default=100,
    ...
    argparser.add_argument("--dropout_ratio", type=float, default=0.1,
                           help=("The proportion of RNN outputs to "
                                 "drop out."))
    argparser.add_argument("--log_period", type=int, default=500,
                           help=("Number of steps between each summary "
                                 "op evaluation."))
    argparser.add_argument("--val_period", type=int, default=500,
    ...
    argparser.add_argument("--model_name", type=str, default='bimpm',
    ...
    vars(config)["char_vocab_size"] = data_manager.get_char_vocab_size()
    ...
    # Get the embeddings.
    embedding_matrix,char_embedding_matrix = data_manager.get_embedd_matrix(True)
