...
class Ranking(object):
    def __init__(
      ...
      embedding_size, filter_sizes, num_filters, num_hidden, l2_reg_lambda=0.0):
        ...
        self.h_pool_left = tf.reshape(tf.concat(axis=3, values=pooled_outputs_left), [-1, num_filters_total], name='h_pool_left')
        self.h_pool_right = tf.reshape(tf.concat(axis=3, values=pooled_outputs_right), [-1, num_filters_total], name='h_pool_right')
